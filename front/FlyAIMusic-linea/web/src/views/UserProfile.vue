    ...
    <el-card style="margin-bottom: 20px; width: 100%;">
      <el-row :gutter="20">
        <el-col :span="8">
          <div>
            <h3>Total Income</h3>
            <div class="font-bold" style="color:red">{{ totalIncome }} {{ globalData.unit }}</div>
        ...
        <el-col :span="8">
          <div>
            ...
            <div class="font-bold" style="color:green">{{ monthlyIncome }} {{ globalData.unit }}</div>
        ...
        <el-col :span="8">
          <div>
            ...
            <div class="font-bold" style="color:blue">{{ pendingSettlement }} {{ globalData.unit }}</div>
