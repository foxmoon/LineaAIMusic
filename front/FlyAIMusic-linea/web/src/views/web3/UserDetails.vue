  ...
  <main class="container mx-auto px-6 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
      ...
      <div class="bg-white rounded-lg shadow-md p-6 text-center">
        ...
        <p class="text-3xl font-bold text-purple-600">15.7 {{ globalData.unit }}</p>
      </div>
      <div class="bg-white rounded-lg shadow-md p-6 text-center">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
      ...
      <div class="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="p-4">
          ...
          <div class="flex justify-between items-center">
            <span class="text-purple-600 font-bold">0.5 {{ globalData.unit }}</span>
      ...
      <div class="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="p-4">
          ...
          <div class="flex justify-between items-center">
            <span class="text-purple-600 font-bold">0.8 {{ globalData.unit }}</span>
            <button class="bg-purple-600 text-white px-3 py-1 rounded-full text-sm hover:bg-purple-700">View</button>
          </div>
        </div>
      </div>
      ...
      <div class="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="p-4">
          ...
          <div class="flex justify-between items-center">
            <span class="text-purple-600 font-bold">0.1 {{ globalData.unit }}</span>
            <button class="bg-purple-600 text-white px-3 py-1 rounded-full text-sm hover:bg-purple-700">View</button>
          </div>
        </div>
      </div>
