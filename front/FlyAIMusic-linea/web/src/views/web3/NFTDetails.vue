        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
          <div class="flex justify-between items-center mb-4">
            <div>
              ...
              <p class="text-2xl font-bold text-purple-600">2.5 {{ globalData.unit }}</p>
            </div>
            <div>
      ...
      <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tr>
            ...
            <td class="px-6 py-4 whitespace-nowrap">2.5 {{ globalData.unit }}</td>
            <td class="px-6 py-4 whitespace-nowrap">StardustArtist</td>
            <td class="px-6 py-4 whitespace-nowrap">-</td>
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div class="p-4">
            ...
            <p class="text-purple-600 font-bold">1.8 {{ globalData.unit }}</p>
          </div>
        </div>
        <!-- Similar NFT Item 2 -->
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div class="p-4">
            ...
            <p class="text-purple-600 font-bold">2.2 {{ globalData.unit }}</p>
          </div>
        </div>
