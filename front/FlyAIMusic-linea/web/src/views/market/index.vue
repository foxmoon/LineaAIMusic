...
import {getWeb3Accounts} from '@/hooks/web3.ts';
        ...
        <header>
            <nav>
                <ul class="nav-body">
                    ...
                    <li class="nav-item btn" @click="handleRouter('recommend')">Explore</li>
                    <li class="nav-item btn" @click="handleRouter('CreateNFT')">Create</li>
                    <li class="nav-item btn" @click="handleRouter('Marketplace')">Marketplace</li>
                    <li class="nav-item btn" @click="handleRouter('Community')">Community</li>
                    <li class="nav-item btn" @click="handleRouter('Artists')">Artists</li>
